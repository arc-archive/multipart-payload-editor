...
import styles from './MultipartPayloadEditorStyles.js';
 ...
 * @extends LitElement
 */
export class MultipartPayloadEditor extends ApiFormMixin(ValidatableMixin(LitElement)) {
  get styles() {
    return [
      prismStyles,
      formStyles,
   ...
   * @return {Promise<object>} Read content.
   */
  _blobToString(blob) {
